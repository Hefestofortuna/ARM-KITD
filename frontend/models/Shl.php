...
class Shl extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'page_serch' => 'Колличество проверенных листов',
            'page_fix' => 'Колличество исправленных листов',
            'page_retur' => 'Колличество возвращенных листов',
            'fix_serch' => 'Изменения проверил ШЛи',
