...
<div class="scheme-view">
    ...
    <div class="row">
                    ...
                    <div class="panel panel-danger">
                        ...
                        <?= Yii::$app->user->identity->post != "1" ? '<li class="list-group-item">' . Html::a('Изменить', ['/shch/update','id' => $model->shch->id], ['class' => 'btn btn-primary'] ) .'</li>' : null ?>
                        </ul>
                    </div>
                    </div>
                    ...
                    <div class="panel panel-success">
                        ...
                        <?= Yii::$app->user->identity->post != "2" ? '<li class="list-group-item">' . Html::a('Изменить', ['/shl/update','id' => $model->shl->id], ['class' => 'btn btn-primary'] ) .'</li>' : null ?>
                        </ul>
                    </div>
                    </div>
